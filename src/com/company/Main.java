...
class Main {
    ...
    public static Scanner dir = new Scanner(System.in);
    ...
    public static void Menú() {
        ...
        try {
            ...
            direccion = dir.nextLine();
            guarda(direccion.trim());
        }
        catch (Exception e) {
    ...
    public static void Determinante() {
        ...
        RR = Double.toString(determinante) ;
    }
    ...
    public static void suma() {
        ...
        {
            System.out.println("las matrices deben tener la misma dimension");
            suma();
        }
    }
    ...
    public static void html()
    {
        ...
        File c = new File("bordar"+cont+".html");
        ...
        try {
            ...
            String url = "bordar"+cont+".html";
            String urls = "bordar.css";
    ...
    public static void htmlparauno()
    {
        File css = new File("bordar.css");
        String csss = "@import url(https://fonts.googleapis.com/css?family=Fjalla+One);\n" + "\n" + "$background: linear-gradient(to bottom, #405166 0%,#656f6f 100%);\n" + "$red: #e55643 ;\n" + "$green: #2b9f5e;\n" + "$yellow: #f1c83c;\n" +
                "$shadow: #533d4a;\n" +
